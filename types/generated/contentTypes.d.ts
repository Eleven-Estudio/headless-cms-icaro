...
export interface ApiCallCall extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::call.call', 'title'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    type: Attribute.Relation<
      'api::call.call',
      'manyToOne',
      'api::type-article.type-article'
    >;
    pay: Attribute.Component<'integrations.pagos'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiTransparenciaTransparencia extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['IMAGEN', 'PDF']> & Attribute.DefaultTo<'PDF'>;
    category: Attribute.String;
...
export interface ApiTypeArticleTypeArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    articles: Attribute.Relation<
      ...
      'api::call.call'
    >;
    slug: Attribute.UID<'api::type-article.type-article', 'name'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::type-article.type-article': ApiTypeArticleTypeArticle;
    }
  }
}
